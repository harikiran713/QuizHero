    ...
    >
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="relative backdrop-blur-md bg-white/10 rounded-2xl shadow-2xl overflow-hidden border border-white/20 hover:shadow-purple-500/20 transition-shadow">
